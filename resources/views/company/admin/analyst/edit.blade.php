...
<header class="head">
        ...
        <div class="inner bg-container">
            @if(count($errors) > 0)
                ...
                @endif
              <form method="POST" action="/analyst/{{$analysis->id}}/update" enctype="multipart/form-data">
                    {{csrf_field()}}

                    <div class="form-group">
                        <label for="email" class="col-form-label"> Judul Berita</label>
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="title" placeholder="Title" value="{{$analysis->title}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group input-group-prepend">
                            <input type="text" class="form-control  form-control-md" required name="post_by" placeholder="Post By" value="{{$analysis->post_by}}" >
                        </div>
                    </div>
